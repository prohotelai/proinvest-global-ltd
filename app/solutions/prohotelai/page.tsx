...
export const metadata: Metadata = {
  title: 'ProHotelAI - AI-Powered Hotel Operations Platform | Proinvest Global',
  description: 'ProHotelAI: 24/7 AI Guest Assistant, automated guest services, front desk automation, and operational analytics for hotels and resorts.',
  openGraph: {
    title: 'ProHotelAI - Transform Hotel Operations with AI',
    description: 'AI-powered platform for hotels featuring 24/7 guest assistance, service automation, and operational analytics.',
  },
};
